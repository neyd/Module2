...
public class RecipeGenerator {
    ...
    public static String[] product = {
            ...
            "Вода",
            "Курячі стегенця",
            "трохи свинини або яловичини.",
            "1-2 різновиди макаронів",
            "Гречана, пшоняна крупи і риc",
            "Свіжоморожена риба",
            "ПомідориЗелень",
            "Яблука",
            "Банани",
            ...
            "Свинина",
            "Яловичина",
            "Риба (минтай, камбала, морський язик і т. д)",
            "Гриби свіжі (печериці, опеньки)",
            "Фрикадельки і котлети",
            "Тісто листкове",
            "Макарони (ріжки, пір’я і т. д)",
            "Спагетті",
            "Гречка",
            "Перловка",
            "Рис",
